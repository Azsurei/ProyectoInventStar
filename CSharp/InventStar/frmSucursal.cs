...
namespace InventStar
{
    public partial class frmSucursal : Form
    {
        ...
        public frmSucursal(cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        {
            frmPaginaPermisos fromPerm = new frmPaginaPermisos(_cuentaPersonal);
            this.Hide();
        ...
        {
            frmDetalleSucursal formSuc = new frmDetalleSucursal(_cuentaPersonal);
            this.Hide();
            formSuc.ShowDialog();
        }
        ...
        private void dgvSucursales_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            frmDetalleSucursal2 formDet = new frmDetalleSucursal2(_sucursalSeleccionado, _cuentaPersonal);
            this.Hide();
            formDet.ShowDialog();
        }
    }
