...
namespace InventStar
{
    public partial class frmPromociones : Form
    {
        ...
        public frmPromociones(tarjetaInventstar tarjetaSeleccionada, cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        {
            frmTarjetas formTar = new frmTarjetas(_tarjetaSeleccionada, _cuentaPersonal);
            this.Hide();
            formTar.ShowDialog();
        }
