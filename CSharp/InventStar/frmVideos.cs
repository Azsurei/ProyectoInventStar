...
namespace InventStar
{
    public partial class frmVideos : Form
    {
        ...
        public frmVideos(cuentaPersonal cuentaUsuario)
        {
            InitializeComponent();
        ...
        {
            frmGuias formGuia = new frmGuias(_cuentaUsuario);
            this.Hide();
            formGuia.ShowDialog();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            frmVerVideo formVerVideo = new frmVerVideo(id, nombre, _cuentaUsuario);
            this.Hide();
