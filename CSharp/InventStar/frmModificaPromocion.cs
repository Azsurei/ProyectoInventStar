...
namespace InventStar
{
    public partial class frmModificaPromocion : Form
    {
        ...
        public frmModificaPromocion(promocionPersonalizada _promocionSeleccionada,cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        {
            frmTarjetas formTar = new frmTarjetas(promocionSeleccionada.tarjeta, _cuentaPersonal);
            this.Hide();
            formTar.ShowDialog();
        }
