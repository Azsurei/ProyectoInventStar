...
namespace InventStar
{
    public partial class frmAgregarProducto : Form
    {
        ...
        public frmAgregarProducto(cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (rbBebida.Checked)
            {
                ...
                resultado = _daoInventario.insertarBebida(_bebida);
            }
            else if (rbComida.Checked)
            {
                ...
                resultado = _daoInventario.insertarComida(_comida);
            }
        ...
        private void rbComida_CheckedChanged(object sender, EventArgs e)
        {
