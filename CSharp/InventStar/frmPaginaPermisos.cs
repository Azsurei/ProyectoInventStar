...
namespace InventStar
{
    public partial class frmPaginaPermisos : Form
    {
        ...
        public frmPaginaPermisos(cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        {
            frmGuias frmGuia = new frmGuias(_cuentaPersonal);
            this.Hide();
            frmGuia.ShowDialog(); 
        }
        ...
        {
            frmClientes formCli = new frmClientes(_cuentaPersonal);
            this.Hide();
            formCli.ShowDialog();
        }
        ...
        {
            frmRoles formRoles = new frmRoles(_cuentaPersonal);
            this.Hide();
        ...
        {
            frmProveedores formProveedores = new frmProveedores(_cuentaPersonal);
            this.Hide();
        ...
        {
            frmSucursal formSucursal = new frmSucursal(_cuentaPersonal);
            this.Hide();
        ...
        {
            frmPaginaPrincipal1 formPagPrin1=new frmPaginaPrincipal1(_cuentaPersonal);
            this.Hide();
