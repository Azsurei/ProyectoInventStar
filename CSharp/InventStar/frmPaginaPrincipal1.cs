...
namespace InventStar
{
    public partial class frmPaginaPrincipal1 : Form
    {
        ...
        public frmPaginaPrincipal1(cuentaPersonal cuentaUsuario)
        {
            InitializeComponent();
        ...
        {
            frmProductos formProd = new frmProductos(_cuentaUsuario);
            this.Hide();
            formProd.ShowDialog();
        }
        ...
        {
            frmPaginaPermisos formPermisos= new frmPaginaPermisos(_cuentaUsuario);
            this.Hide();
