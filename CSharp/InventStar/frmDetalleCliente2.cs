...
namespace InventStar
{
    public partial class frmDetalleCliente2 : Form
    {
        ...
        public frmDetalleCliente2(cliWS.cliente _clienteSeleccionado, cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            frmTarjetas formTar = new frmTarjetas(_tarjetaInventstar, _cuentaPersonal);
            this.Hide();
            formTar.ShowDialog();
        }
