...
namespace InventStar
{
    ...
    {
        private InventarioWSClient daoMerch;
        private BindingList<mercancia> listaMercancias;
        ...
        public frmMerch(cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
            daoMerch = new InventarioWSClient();
        ...
        {
            _linea.cantidad = 1;
            _linea.subtotal = _mercancia.precioUnitario;
            _linea.item = new PersonalWS.itemVenta();
            _linea.item.idItemVenta = _mercancia.idItemVenta;
            _linea.item.nombre = _mercancia.nombre;
            _linea.item.descripcion = _mercancia.descripcion;
            _linea.item.precioUnitario = _mercancia.precioUnitario;
