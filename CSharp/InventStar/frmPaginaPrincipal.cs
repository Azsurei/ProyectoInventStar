...
namespace InventStar
{
    public partial class frmPaginaPrincipal : Form
    {
        ...
        public PictureBox PBProductosEnabled
        {
            get => pbProductosEnabled;
            set => pbProductosEnabled = value;
        }
        ...
        public frmPaginaPrincipal(cuentaPersonal cuentaUsuario)
        {
            InitializeComponent();
            InitializeFontCollection();
        ...
        {
            frmGuias frmGuia = new frmGuias(_cuentaUsuario);
            this.Hide();
            frmGuia.ShowDialog(); 
        }
        ...
        {
            frmClientes formCli = new frmClientes(_cuentaUsuario);
            this.Hide();
            formCli.ShowDialog();
        }
        ...
        {
            frmInventario formInv= new frmInventario(_cuentaUsuario);
            this.Hide();
            formInv.ShowDialog();
        }
        ...
        {
            frmBebidas formBebidas = new frmBebidas(_cuentaUsuario);
            this.Hide();
        ...
        {
            frmProveedores formProveedores = new frmProveedores(_cuentaUsuario);
            this.Hide();
            formProveedores.ShowDialog();
        }

        private void pbProductosEnabled_Click(object sender, EventArgs e)
        {
            frmProductos formPro = new frmProductos(_cuentaUsuario);
            this.Hide();
            formPro.ShowDialog();
        }
