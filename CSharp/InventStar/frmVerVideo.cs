...
namespace InventStar
{
    public partial class frmVerVideo : Form
    {
        ...
        public frmVerVideo(int id, string titulo, cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
            _daoPersonal = new PersonalWSClient();
            this._cuentaUsuario = cuentaPersonal;
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            ...
            frmVideos formVideos = new frmVideos(_cuentaUsuario);
            this.Hide();
