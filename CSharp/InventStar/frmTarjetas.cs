...
namespace InventStar
{
    public partial class frmTarjetas : Form
    {
        ...
        public frmTarjetas(tarjetaInventstar _tarjetaSeleccionada,cuentaPersonal cuentaPersonal)
        {
            InitializeComponent();
        ...
        {
            frmDetalleCliente2 formDet2 = new frmDetalleCliente2(_tarjetaSeleccionada.cliente, _cuentaPersonal);
            this.Hide();
            formDet2.ShowDialog();
        }
        ...
        {
            frmPromociones formProm = new frmPromociones(_tarjetaSeleccionada, _cuentaPersonal);
            this.Hide();
            formProm.ShowDialog();
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            frmModificaPromocion formModProm = new frmModificaPromocion(_promocionSeleccionada, _cuentaPersonal);
            this.Hide();
