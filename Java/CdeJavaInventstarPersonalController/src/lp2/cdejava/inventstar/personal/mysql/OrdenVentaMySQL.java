...
public class OrdenVentaMySQL implements OrdenVentaDAO {
    ...
    public int insertar(OrdenVenta ordenVenta) {
        ...
        try {
            ...
            cst.setTime("_horaVentaOrdenventa", new java.sql.Time(ordenVenta.getHoraVenta().getTime()));
            cst.setTime("_horaFinPedidoOrdenventa", new java.sql.Time(ordenVenta.getHoraFinPedido().getTime()));
            ...
            if(ordenVenta.getPersonal() != null) {
                cst.setInt("_fidPersonal", ordenVenta.getPersonal().getIdPersona());
            } else {
                cst.setInt("_fidPersonal", java.sql.Types.INTEGER);
            }
            if(ordenVenta.getCliente() != null) {
                cst.setInt("_fidCliente", ordenVenta.getCliente().getIdPersona());
            } else {
                cst.setInt("_fidCliente", java.sql.Types.INTEGER);
            }
            if(ordenVenta.getSucursal() != null) {
                cst.setInt("_fid_sucursal", ordenVenta.getSucursal().getId_sucursal());
            } else {
                cst.setInt("_fid_sucursal", java.sql.Types.INTEGER);
            }
            if(ordenVenta.getTransaccion() != null) {
                cst.setInt("_fid_transaccion", ordenVenta.getTransaccion().getIdTransaccion());
            } else {
                cst.setInt("_fid_transaccion", java.sql.Types.INTEGER);
            }
            if(ordenVenta.getResenha() != null) {
                cst.setInt("_fid_resenha", ordenVenta.getResenha().getIdReseña());
            } else {
                cst.setInt("_fid_resenha", java.sql.Types.INTEGER);
            }
            cst.executeUpdate();
            ordenVenta.setIdVenta(cst.getInt("_idOrdenVenta"));
            respuesta = ordenVenta.getIdVenta();
        } catch(Exception ex){
    ...
    public ArrayList<OrdenVenta> listarOrdenVenta() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                ordenVenta.setHoraVenta(rs.getTime("horaVentaOrdenventa"));
                ordenVenta.setHoraFinPedido(rs.getTime("horaFinPedidoOrdenventa"));
                ...
                ordenVenta.getTransaccion().setHora(rs.getTime("horaTransaccion"));
